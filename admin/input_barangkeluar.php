  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">input data barang keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$query = mysqli_query($kon, "SELECT max(id_brgkeluar) as max_kode FROM tbbarang_keluar");
$data = mysqli_fetch_array($query);
// Sudah dapat nih gan
$id_brgkeluar = $data['max_kode'];

// Oke sekarang kita ambil bagian angkanya saja dan membuang string yang ada diawal
$no = substr($id_brgkeluar, 5, 4);
...
$stok   = $res['stok'];
$stok_akhir = $res['stok'] - $jumlah_keluar;
    ...
    $cek = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM tbbarang_keluar WHERE id_brgkeluar='$id_brgkeluar'"));

    if ($cek > 0){
    echo "<script>window.alert('data obat sudah ada coba cek ulang')
    window.location='data_barangkeluar.php'</script>";
    }else {
    mysqli_query($kon, "INSERT INTO tbbarang_keluar (id_brgkeluar, id_barang,jumlah_keluar,tgl_keluar,warna,ukuran,tujuan) VALUES ('$id_brgkeluar', '$id_barang', '$jumlah_keluar', '$tgl_keluar', '$warna', '$ukuran', '$tujuan')");
    ...
    ?>
            ...
            <!-- Horizontal Form -->
             <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             <form class="forms-sample" action="input_barangkeluar.php" method="post" >
                <div class="card-body">
                  ...
                  <div class="form-group">
                     <label> id transaksi</label>
                       ...
                       <input name="id_brgkeluar" type="text" id="id_brgkeluar" class="form-control" placeholder="Tidak perlu di isi" value="<?php echo $newKode; ?>" autofocus="on" readonly="readonly" />
                    ...
                    <input type="date" class="form-control" id="tgl_keluar" name="tgl_keluar" value="<?php echo date("Y-m-d"); ?>" placeholder="tgl_keluar">
                  </div>
 ...
 <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jumlah_keluar" name="jumlah_keluar" placeholder=" jumlah keluar">
                  </div>
