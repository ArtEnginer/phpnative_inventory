  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-lg-12 col-6">
           ...
           <div class="card">
              <div class="card-header">
                   <a href="input_barangmasuk.php" class="btn btn-sm btn-primary"><i class=""></i> Tambah data</a> 

                    <right> <a href="cetak_barangmasuk.php" class="btn btn-sm btn-primary" target="_blank"><i class=""></i> Cetak </a> </right>
        ...
        $cek = mysqli_query($kon, "SELECT * FROM tbbarang_masuk WHERE id_brgmasuk='$id_brgmasuk'");
        if(mysqli_num_rows($cek) == 0){

          
        }else{
          $delete = mysqli_query($kon, "DELETE FROM tbbarang_masuk WHERE id_brgmasuk='$id_brgmasuk'");
          if($delete){
                  ...
                  <tbody>
                    ...
                    <td><left><?php echo $data['jumlah']; ?></center></td>
                      ...
                      <td><center><div id="thanks">
                       ...
                       <a onclick="return confirm ('Yakin hapus <?php echo $data['id_brgmasuk'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data pasien" href="data_barangmasuk.php?aksi=hapus&id_brgmasuk=<?php echo $data['id_brgmasuk'];?>">Hapus <span class="glyphicon glyphicon-trash"></a></center>
